...
<div class="flex justify-center"> <!-- Centrar el contenedor principal -->
    <div class="max-w-2xl mx-auto py-8 px-6 rounded-lg shadow-md flex-grow" style="background-color: rgb(34, 37, 42);"> <!-- Contenedor con mejor diseño -->
                ...
                <div class="flex items-center space-x-4">
                    <label class="block flex-grow">
                        ...
                        <input type="text" name="dni" id="dni" value="{{ old('dni') }}"
                            class="mt-1 block w-full rounded-md border-red-500 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 p-2" required>
                    </label>
        ...
        <div id="additionalSection" class="mt-6 p-4 rounded-lg text-white" style="background-color: rgb(46, 49, 54); display: none;">
            <button type="button" id="registerButton" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-500">Registrar</button>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('createSchedule').addEventListener('click', function() {
            ...
            const fechaCita = new Date(fecha).toLocaleDateString('es-ES', { year: 'numeric', month: 'long', day: 'numeric' });
            let outputHtml = `
