    ...
    <div class="flex flex-col">
        ...
        <div class="w-full mb-2">
            <a href="{{ route('noticias') }}" id="btnNoticias"
                class="inline-block text-white font-normal py-2 px-4 transition-all transform hover:scale-105 @if (request()->routeIs('noticias') ||
                        Str::startsWith(request()->url(), route('noticias')) ||
                        request()->routeIs('editar') ||
                        request()->routeIs('eliminar')) bg-gray-600 @else bg-transparent @endif w-full relative">
                <div id="bar-btnNoticias"
                    class="absolute top-0 left-0 h-full bg-red-500 {{ request()->routeIs('noticias') || Str::startsWith(request()->url(), route('noticias')) || request()->routeIs('editar') || request()->routeIs('eliminar') ? 'block' : 'hidden' }}"
                    style="width: 3px;"></div>
        ...
        <div class="w-full mb-2">
            <a href="{{ route('añadirdoctor') }}" id="btnDoctor"
                class="inline-block text-white font-normal py-2 px-4 transition-all transform hover:scale-105 @if (request()->routeIs('añadirdoctor') || request()->routeIs('guardardoctor')) bg-gray-600 @else bg-transparent @endif w-full relative">
                <div id="bar-btnDoctor"
                    class="absolute top-0 left-0 h-full bg-red-500 {{ request()->routeIs('añadirdoctor') || request()->routeIs('guardardoctor') ? 'block' : 'hidden' }}"
                    style="width: 3px;"></div>
        ...
        <div class="w-full mb-2">
            <a href="{{ route('añadirhorario') }}" id="btnHorario"
                class="inline-block text-white font-normal py-2 px-4 transition-all transform hover:scale-105 @if (request()->routeIs('añadirhorario')) bg-gray-600 @else bg-transparent @endif w-full relative">
                <div id="bar-btnHorario"
                    class="absolute top-0 left-0 h-full bg-red-500 {{ request()->routeIs('añadirhorario') ? 'block' : 'hidden' }}"
                    style="width: 3px;"></div>
